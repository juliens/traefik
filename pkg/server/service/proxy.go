...
func newFastHTTPReverseProxy(client *fasthttp.Client) (http.Handler, error) {
	...
	proxy := &httputil.ReverseProxy{
		Director: func(outReq *http.Request) {
			...
			val := outReq.Header["Sec-Websocket-Key"]
			outReq.Header["Sec-WebSocket-Key"] = val
			val = outReq.Header["Sec-Websocket-Extensions"]
			outReq.Header["Sec-WebSocket-Extensions"] = val
			val = outReq.Header["Sec-Websocket-Accept"]
			outReq.Header["Sec-WebSocket-Accept"] = val
			val = outReq.Header["Sec-Websocket-Protocol"]
			outReq.Header["Sec-WebSocket-Protocol"] = val
			val = outReq.Header["Sec-Websocket-Version"]
